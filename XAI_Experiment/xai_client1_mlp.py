...
display_name = "fl_xai_client1_mlp_3client_1epochs_36round_100b_gpu"
...
class ntcClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        model.save("model_xai_client1_mlp_3client_1epochs_36round_100b_gpu.h5")
