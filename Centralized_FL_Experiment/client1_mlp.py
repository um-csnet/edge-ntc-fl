...
#load dataset
x_train = np.load("x_bal-train-client 1.npy")
y_train = np.load("y_bal-train-client 1.npy")

x_test = np.load("x_bal-test-client 1.npy")
y_test = np.load("y_bal-test-client 1.npy")
...
display_name = "fl_client1_mlp_3client_36epochs_1round_gpu"
...
class ntcClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        model.save("model_client1_mlp_3client_36epochs_1round_gpu.h5")
